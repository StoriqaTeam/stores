...
/// of this trait.
pub trait Acl<Resource, Action, Scope, Rule, Error, T> {
...
#[allow(unused)]
impl<Resource, Action, Scope, Rule, Error, T> Acl<Resource, Action, Scope, Rule, Error, T> for SystemACL {
    fn allows(
        &self,
        resource: Resource,
        action: Action,
...
#[allow(unused)]
impl<Resource, Action, Scope, Rule, Error, T> Acl<Resource, Action, Scope, Rule, Error, T> for UnauthorizedACL {
    fn allows(
        &self,
        resource: Resource,
        action: Action,
